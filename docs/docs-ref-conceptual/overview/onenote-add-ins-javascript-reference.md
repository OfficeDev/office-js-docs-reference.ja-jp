# <a name="onenote-javascript-api-overview"></a><span data-ttu-id="535b2-101">OneNote の JavaScript API の概要</span><span class="sxs-lookup"><span data-stu-id="535b2-101">OneNote JavaScript API overview</span></span>
