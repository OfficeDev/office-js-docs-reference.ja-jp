# <a name="excel-javascript-api-overview"></a><span data-ttu-id="79233-101">Excel の JavaScript API の概要</span><span class="sxs-lookup"><span data-stu-id="79233-101">Excel JavaScript API overview</span></span>
