# <a name="permissions-element"></a><span data-ttu-id="8820e-101">Permissions 要素</span><span class="sxs-lookup"><span data-stu-id="8820e-101">Permissions element</span></span>
