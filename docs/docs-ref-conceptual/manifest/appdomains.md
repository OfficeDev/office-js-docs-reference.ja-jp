# <a name="appdomains-element"></a><span data-ttu-id="7a39b-101">AppDomains 要素</span><span class="sxs-lookup"><span data-stu-id="7a39b-101">AppDomains element</span></span>
