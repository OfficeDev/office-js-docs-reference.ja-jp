# <a name="appdomains-element"></a><span data-ttu-id="a1a21-101">AppDomains 要素</span><span class="sxs-lookup"><span data-stu-id="a1a21-101">AppDomains element</span></span>
