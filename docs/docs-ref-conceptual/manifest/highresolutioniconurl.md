# <a name="highresolutioniconurl-element"></a><span data-ttu-id="78eb9-101">HighResolutionIconUrl 要素</span><span class="sxs-lookup"><span data-stu-id="78eb9-101">HighResolutionIconUrl element</span></span>
