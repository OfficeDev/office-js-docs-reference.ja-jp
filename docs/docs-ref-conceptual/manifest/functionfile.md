# <a name="functionfile-element"></a><span data-ttu-id="d7f7b-101">FunctionFile 要素</span><span class="sxs-lookup"><span data-stu-id="d7f7b-101">FunctionFile element</span></span>
