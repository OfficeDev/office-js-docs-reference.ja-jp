# <a name="webapplicationinfo-element"></a><span data-ttu-id="3bb3a-101">WebApplicationInfo 要素</span><span class="sxs-lookup"><span data-stu-id="3bb3a-101">WebApplicationInfo element</span></span>
