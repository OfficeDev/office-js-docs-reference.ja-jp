# <a name="webapplicationinfo-element"></a><span data-ttu-id="c88f2-101">WebApplicationInfo 要素</span><span class="sxs-lookup"><span data-stu-id="c88f2-101">WebApplicationInfo element</span></span>
