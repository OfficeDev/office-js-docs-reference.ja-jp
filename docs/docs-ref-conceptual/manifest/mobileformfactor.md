# <a name="mobileformfactor-element"></a><span data-ttu-id="b55c1-101">MobileFormFactor 要素</span><span class="sxs-lookup"><span data-stu-id="b55c1-101">MobileFormFactor element</span></span>
