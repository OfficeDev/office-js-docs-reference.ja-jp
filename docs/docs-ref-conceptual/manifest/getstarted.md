# <a name="getstarted-element"></a><span data-ttu-id="f35dd-101">GetStarted 要素</span><span class="sxs-lookup"><span data-stu-id="f35dd-101">GetStarted element</span></span>
