...
> [!NOTE]
> **LearnMoreUrl**は、Word、Excel、または PowerPoint のクライアントで現在は表示されません。 これが利用可能になったときに URL がレンダリングされるよう、すべてのクライアントにこの URL を追加することをお勧めします。 
...
* [PowerPoint アドインで Microsoft Graph を使用して Excel のグラフを挿入します。](https://github.com/OfficeDev/PowerPoint-Add-in-Microsoft-Graph-ASPNET-InsertChart)
