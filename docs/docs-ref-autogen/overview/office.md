# <a name="office-javascript-api-reference"></a><span data-ttu-id="dcaf9-101">Office の JavaScript API のリファレンス</span><span class="sxs-lookup"><span data-stu-id="dcaf9-101">Office JavaScript API reference</span></span>
