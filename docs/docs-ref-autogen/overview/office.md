# <a name="office-javascript-api-reference"></a><span data-ttu-id="8ed48-101">Office の JavaScript API のリファレンス</span><span class="sxs-lookup"><span data-stu-id="8ed48-101">Office JavaScript API reference</span></span>
